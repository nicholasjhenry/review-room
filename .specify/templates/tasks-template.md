...
> **NOTE: Write these tests FIRST, ensure they FAIL before implementation and cover every cross-boundary interaction**
...
- [ ] TXXX [P] Additional unit and integration tests in tests/unit/ and tests/integration/ as needed
