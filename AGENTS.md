...
### Design system – Spec 003

- Reference `assets/css/design-system.css` for the Tailwind v4 + DaisyUI extension plan captured in `/specs/003-revamp-ui-design/plan.md`
- Follow the documented section index (tokens, DaisyUI themes, component primitives, accessibility) when adding styles so later phases stay aligned with the redesign roadmap
- Keep motion utilities under 200ms and surface reduced-motion fallbacks alongside the shared CSS custom properties defined in the design-system file
